...
base_dir="/storage/htc/bdm/tosin/GSDB/Data/*"
output_dir="/storage/htc/bdm/tosin/GSDB/Chromosome3D_Data/"
			...
			then
				...
				for direct in $nextdir/*; do
					...
					then
						...
						#Matrix Directory
						echo $path_to_output2									
						
						echo "....Copy Started................."
						cur_matrix="$direct/chr*_matrix.txt"						
