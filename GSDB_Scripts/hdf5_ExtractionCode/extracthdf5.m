path = '/storage/htc/bdm/tosin/GSDB/Data/ENCSR213DHH_IH3677AS/Processed_Data/Large_Datasets/';

hdfname = 'GSE105318_ENCFF439QFU';

filename = [path,hdfname,'_chromatin_interactions_hg19.h5'];
...
path= ['/storage/htc/bdm/tosin/GSDB/Data/ENCSR213DHH_IH3677AS/',hdfname,'/'];
mkdir(path);
%----------------------------------------------------
%======================================================
