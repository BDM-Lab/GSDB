...
The python script visualization.py convenient could be used to conduct a visuali-
zation to the output results. The output file can be converted into pdb format.
...
After July 2015, I will transit to Duke University. My new email address:
siyu.wang@duke.edu
------------------------------------------------------------------------------------
