...
%---------------------------------------------------------------------%
%inputdata = list input data%
%ChrNo= chromosome number%
%filename= file name for InfMod3DGen %
%n = number of structures
function ChrMod_main(inputdata,filename,name, ChrNo,n)

create_dataInput; %created a new input data to be used a input

%Process the original data to a simple format of interaction frequency information that can be further processed
ChrIF=PreProcess(ChrNo,inputdata);
