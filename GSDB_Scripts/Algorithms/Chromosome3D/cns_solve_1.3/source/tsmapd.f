C=======================================================================
C{
      subroutine dftsSw3(Wm1, Wm2, Wm3, Wn, ws3,
     &                   fcg, nfcg,
     &                   xrh, xrk, xrl,
     ...
     &                   hMs, kMs, lMs, fts)
      IMPLICIT NONE
C I/O
      integer           Wm1, Wm2, Wm3, Wn(3)
      double complex    ws3(0:Wm1/2-1, 0:Wm2-1, 0:Wm3-1)
      double complex    fcg(*)
      integer           nfcg(3)
...
C
      call FillC8(ws3, (Wm1 / 2) * Wm2 * Wm3, CZero)
C
      do iRef = 1, nRef
        mH = Mult(iRef)
        if (mH .gt. 0) then
...
C
     ...
     &             * dconjg(fpart(iRef))
              if (vWi)
     &            ws3(Wi(1),Wi(2),Wi(3))
     &          = ws3(Wi(1),Wi(2),Wi(3)) +        cf
              if (vWj)
     &            ws3(Wj(1),Wj(2),Wj(3))
     &          = ws3(Wj(1),Wj(2),Wj(3)) + dconjg(cf)
            end if
C
            do iS1 = 1, nSymMx
              hM01 = hM0 - hMs(iS1)
...
C=======================================================================
C{
      subroutine dftsSw1(Wm1, Wm2, Wm3, Wn, ws1,
     &                   fcg, nfcg,
     &                   xrh, xrk, xrl,
     &                   Mult, fpart, nRef, QHerm, QFpart,
     &                   SymMx, mSymMx, nSymMx, STBF,
...
C I/O
      integer           Wm1, Wm2, Wm3, Wn(3)
      double complex    ws1(0:Wm1/2-1, 0:Wm2-1, 0:Wm3-1)
      double complex    fcg(*)
      integer           nfcg(3)
      integer           xrh(*), xrk(*), xrl(*), Mult(*)
      double complex    fpart(*)
...
C begin
      CZero = dcmplx(Zero, Zero)
C
      call FillC8(ws1, (Wm1 / 2) * Wm2 * Wm3, CZero)
C
      do iRef = 1, nRef
        mH = Mult(iRef)
        if (mH .gt. 0) then
...
C
            if (QFpart) then
              ...
              if (vWi)
     &            ws1(Wi(1),Wi(2),Wi(3))
     &          = ws1(Wi(1),Wi(2),Wi(3)) +        cf
              if (vWj)
     &            ws1(Wj(1),Wj(2),Wj(3))
     &          = ws1(Wj(1),Wj(2),Wj(3)) + dconjg(cf)
            end if
C
            do iS1 = 1, nSymMx
              hM01 = hM0 - hMs(iS1)
...
C=======================================================================
C{
      subroutine dftsSw2(Wm1, Wm2, Wm3, Wn, ws2,
     &                   fcg, nfcg,
     &                   xrh, xrk, xrl,
...
C I/O
      integer           Wm1, Wm2, Wm3, Wn(3)
      double complex    ws2(0:Wm1/2-1, 0:Wm2-1, 0:Wm3-1)
      double complex    fcg(*)
      integer           nfcg(3)
      integer           xrh(*), xrk(*), xrl(*), Mult(*)
...
C begin
      CZero = dcmplx(Zero, Zero)
C
      call FillC8(ws2, (Wm1 / 2) * Wm2 * Wm3, CZero)
C
      do iRef = 1, nRef
        mH = Mult(iRef)
        if (mH .gt. 0) then
...
C
            if (QFpart) then
              ...
              if (vWi)
     &            ws2(Wi(1),Wi(2),Wi(3))
     &          = ws2(Wi(1),Wi(2),Wi(3)) +        cf
              if (vWj)
     &            ws2(Wj(1),Wj(2),Wj(3))
     &          = ws2(Wj(1),Wj(2),Wj(3)) + dconjg(cf)
            end if
C
            do iS1 = 1, nSymMx
              hM01 = hM0 - hMs(iS1)
