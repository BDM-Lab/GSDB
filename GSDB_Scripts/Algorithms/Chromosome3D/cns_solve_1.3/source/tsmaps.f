C=======================================================================
C{
      subroutine sftsSw3(Wm1, Wm2, Wm3, Wn, ws3,
     &                   fcg, nfcg,
     &                   xrh, xrk, xrl,
...
C I/O
      integer           Wm1, Wm2, Wm3, Wn(3)
             complex    ws3(0:Wm1/2-1, 0:Wm2-1, 0:Wm3-1)
      double complex    fcg(*)
      integer           nfcg(3)
...
C
      call FillC4(ws3, (Wm1 / 2) * Wm2 * Wm3, CZero)
C
      do iRef = 1, nRef
        mH = Mult(iRef)
        if (mH .gt. 0) then
...
C=======================================================================
C{
      subroutine sftsSw1(Wm1, Wm2, Wm3, Wn, ws1,
     &                   fcg, nfcg,
     &                   xrh, xrk, xrl,
     &                   Mult, fpart, nRef, QHerm, QFpart,
     &                   SymMx, mSymMx, nSymMx, STBF,
...
C I/O
      integer           Wm1, Wm2, Wm3, Wn(3)
             complex    ws1(0:Wm1/2-1, 0:Wm2-1, 0:Wm3-1)
      double complex    fcg(*)
      integer           nfcg(3)
      integer           xrh(*), xrk(*), xrl(*), Mult(*)
      double complex    fpart(*)
...
C begin
      CZero = dcmplx(Zero, Zero)
C
      call FillC4(ws1, (Wm1 / 2) * Wm2 * Wm3, CZero)
C
      do iRef = 1, nRef
        mH = Mult(iRef)
        if (mH .gt. 0) then
...
C=======================================================================
C{
      subroutine sftsSw2(Wm1, Wm2, Wm3, Wn, ws2,
     &                   fcg, nfcg,
     &                   xrh, xrk, xrl,
...
C I/O
      integer           Wm1, Wm2, Wm3, Wn(3)
             complex    ws2(0:Wm1/2-1, 0:Wm2-1, 0:Wm3-1)
      double complex    fcg(*)
      integer           nfcg(3)
      integer           xrh(*), xrk(*), xrl(*), Mult(*)
...
C begin
      CZero = dcmplx(Zero, Zero)
C
      call FillC4(ws2, (Wm1 / 2) * Wm2 * Wm3, CZero)
C
      do iRef = 1, nRef
        mH = Mult(iRef)
        if (mH .gt. 0) then
