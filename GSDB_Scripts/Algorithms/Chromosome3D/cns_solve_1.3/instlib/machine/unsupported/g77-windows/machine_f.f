...
C begin
      ...
      IF (NAME(1:5).EQ.'INPUT' .AND. FSATTY(0) .NE. 0) THEN
         QTERM=.TRUE.
      ELSE
         QTERM=.FALSE.
      END IF
...
C input/output
      ...
      INTEGER MAX, LENGTH
C begin
      CALL COPYST(USERNM,MAX,LENGTH,'Windows-g77',11)
      RETURN
      END
C=====================================================================
...
C begin
      HOSTNM=' '
      CALL GETENV('COMPUTERNAME', CNAME)
      IF (CNAME .EQ. ' ') THEN
