#!/usr/bin/perl
# <!--
$this_cgi = "cns_libaries.cgi";
$modified = "Last modified 12/08/98 P. Adams";
#
# CGI file for generating library file listing
#
...
&init_html( 'CNSsolve Library Files' , $jscode );
...
open( LS, "ls $library_dir|" );
@subdirs = <LS>;
close LS;

if ($#subdirs < 0) { &die_html("No directories read from $library_dir"); }
...
foreach $subdir (@subdirs) {
	...
	foreach $file (@files) {
	    ...
	    $size = -s "$library_dir/$subdir/$file";
	    ...
	    print "<TD>\n";
	    print "<TABLE CELLSPACING=0 CELLPADDING=2 BORDER=2>\n";
	    print "<TR><TD><A HREF=\"javascript:cnsView(\'libraries/$subdir/$file\')\">\n";
	    print "<IMG SRC=\"$icon_dir/view_small.gif\" ALT=\"VIEW\"\n";
	    print "     BORDER=0 HEIGHT=20 WIDTH=43 ALIGN=CENTER></A></TD>\n";
	    print "<TD><A HREF=\"javascript:cnsSave(\'libraries/$subdir/$file\')\">\n";
