...
set lnfiles=(data/mbp/mbp.pdb \
	     data/mbp/mbp.cv \
             refinement_high_resolution/model_stats/model_stats_start.inp)
#
if ( ! $?CNS_SOLVE ) then
...
echo "        "
echo "running:"
echo "         cns_solve < model_stats_start.inp > model_stats_start.out"
echo "        "
#
cns_solve < model_stats_start.inp > model_stats_start.out
#
echo "        "
#
