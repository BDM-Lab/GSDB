...
set lnfiles=(data/por/refine_twin.pdb \
	     data/por/porin.cv \
             refinement_twin/water_pick/water_pick_twin.inp)
#
if ( ! $?CNS_SOLVE ) then
...
echo "        "
echo "running:"
echo "         cns_solve < water_pick_twin.inp > water_pick_twin.out"
echo "        "
#
cns_solve < water_pick_twin.inp > water_pick_twin.out
#
echo "        "
#
