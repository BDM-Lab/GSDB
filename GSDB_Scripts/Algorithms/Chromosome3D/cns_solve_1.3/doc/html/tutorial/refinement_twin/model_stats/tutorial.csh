...
set lnfiles=(data/por/porin.pdb \
	     data/por/porin.cv \
             refinement_twin/model_stats/model_stats_twin.inp)
#
if ( ! $?CNS_SOLVE ) then
...
echo "        "
echo "running:"
echo "         cns_solve < model_stats_twin.inp > model_stats_twin.out"
echo "        "
#
cns_solve < model_stats_twin.inp > model_stats_twin.out
#
echo "        "
#
