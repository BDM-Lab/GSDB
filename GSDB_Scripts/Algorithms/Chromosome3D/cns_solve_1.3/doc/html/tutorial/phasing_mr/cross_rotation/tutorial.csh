...
set lnfiles=(data/mbp/mbp_cns.pdb \
	     data/mbp/mbp_mr.hkl \
             phasing_mr/cross_rotation/cross_rotation.inp)
#
if ( ! $?CNS_SOLVE ) then
...
echo "        "
echo "running:"
echo "         cns_solve < cross_rotation.inp > cross_rotation.out"
echo "        "
#
cns_solve < cross_rotation.inp > cross_rotation.out
#
echo "        "
#
