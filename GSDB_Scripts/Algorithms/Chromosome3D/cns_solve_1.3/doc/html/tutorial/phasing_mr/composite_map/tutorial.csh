...
set lnfiles=(data/mbp/rigid.pdb \
	     data/mbp/mbp_mr.cv \
	     phasing_mr/composite_map/omac \
             phasing_mr/composite_map/composite_omit_map.inp)
#
if ( ! $?CNS_SOLVE ) then
...
echo "        "
echo "running:"
echo "         cns_solve < composite_omit_map.inp > composite_omit_map.out"
echo "        "
#
cns_solve < composite_omit_map.inp > composite_omit_map.out
#
echo "        "
#
