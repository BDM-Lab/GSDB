...
output_dir="/storage/htc/bdm/tosin/GSDB/Structures/ENCSR507AHE_AX9716PF/"
		...
		for directory in $rootdir; do
				...
				then			
					...
					do				
						...
						python  /storage/htc/bdm/tosin/GSDB_Scripts/Algorithms/miniMDS/minimds.py -m 0.01 -p 0.01 -o $outname  $local_file   
