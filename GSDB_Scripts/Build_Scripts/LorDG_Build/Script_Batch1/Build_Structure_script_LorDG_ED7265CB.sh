		...
		for directory in $rootdir; do
				...
				then			
					...
					do				
						...
						param="local_LorDG_${rootname}_${namedir}_${fname}_${rand}.sh"	
						param="local.sh"
						
						{
							...
							echo "#!/bin/sh"
							echo "#!/bin/bash -l"
							echo "#SBATCH -J LorDG_run"
							echo "#SBATCH -o LorDG_run-%j.out"
							echo "#SBATCH -p Lewis"
							echo "#SBATCH -N 1"
							echo "#SBATCH -n 6"
							echo "#SBATCH --mem 80G"
							...
							echo "param=\"parameters_LorDG_\${rand}.txt\""
							...
							echo "echo \"LEARNING_RATE = 0.07\""
							echo "echo \"MAX_ITERATION = 20000\""
							echo "} > \$param"
							
							echo "# Call the LorDG alg_parameters"							
							echo "java -jar /storage/htc/bdm/tosin/GSDB_Scripts/Algorithms/LorDG.jar \$param"
							echo "rm \$param	"
